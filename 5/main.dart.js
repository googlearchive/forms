...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    JSArray: {
      ...
      fold$2: function(receiver, initialValue, combine) {
        var $length, value, i;
        H.functionTypeCheck(combine, {func: 1, args: [, H.getTypeArgumentByIndex(receiver, 0)]});
    ...
    JSString: {
      ...
      split$1: function(receiver, pattern) {
        ...
        if (typeof pattern === "string") {
          t1 = P.String;
          t2 = [t1];
          return H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(H.assertSubtype(receiver.split(pattern), "$isJSArray", t2, "$asJSArray"), t2), "$isJSArray", t2, "$asJSArray"), "$isList", [t1], "$asList");
        } else {
          t1 = pattern instanceof H.JSSyntaxRegExp && pattern.get$_nativeAnchoredVersion().exec("").length - 2 === 0;
          t2 = P.String;
          t3 = [t2];
          if (t1) {
            t1 = [t2];
            return H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(H.assertSubtype(receiver.split(H.interceptedTypeCheck(pattern, "$isJSSyntaxRegExp")._nativeRegExp), "$isJSArray", t1, "$asJSArray"), t1), "$isJSArray", t1, "$asJSArray"), "$isList", t3, "$asList");
          } else
            return H.assertSubtype(this._defaultSplit$1(receiver, pattern), "$isList", t3, "$asList");
        }
      },
      ...
      _defaultSplit$1: function(receiver, pattern) {
        var t1, result, start, $length, match, matchStart, matchEnd;
        t1 = [P.String];
        ...
        for (t1 = J.allMatches$1$s(pattern, receiver), t1 = t1.get$iterator(t1), start = 0, $length = 1; t1.moveNext$0();) {
          ...
          $length = C.JSInt_methods.$sub(matchEnd, matchStart);
    ...
    }, null, null, 14, 0, null, 37, 35, 36, 14, 15, 30, 57],
    ...
    Primitives_functionNoSuchMethod_closure: {
      "^": "Closure:53;_box_0,$arguments,namedArgumentList",
    ...
    }, "call$1", "async___nullDataHandler$closure", 2, 0, 54, 17],
    _nullErrorHandler: [function(error, stackTrace) {
      H.interceptedTypeCheck(stackTrace, "$isStackTrace");
      $.Zone__current.handleUncaughtError$2(error, stackTrace);
    }, function(error) {
      return P._nullErrorHandler(error, null);
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 7, 0, 2, 4],
    ...
    _rootErrorCallback: [function($self, $parent, zone, error, stackTrace) {
      H.interceptedTypeCheck(stackTrace, "$isStackTrace");
      return;
    }, "call$5", "async___rootErrorCallback$closure", 10, 0, 22],
    ...
    }, "call$5", "async___rootCreateTimer$closure", 10, 0, 55],
    ...
    }, "call$5", "async___rootCreatePeriodicTimer$closure", 10, 0, 56],
    _rootPrint: [function($self, $parent, zone, line) {
      H.printString(H.S(H.stringTypeCheck(line)));
    }, "call$4", "async___rootPrint$closure", 8, 0, 57],
    _printToZone: [function(line) {
      $.Zone__current.print$1(0, line);
    }, "call$1", "async___printToZone$closure", 2, 0, 58],
    _rootFork: [function($self, $parent, zone, specification, zoneValues) {
      ...
      return t1;
    }, "call$5", "async___rootFork$closure", 10, 0, 59, 9, 10, 11, 34, 56],
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 7, 0, 2, 4],
    ...
    _Utf8Decoder_convert_addSingleBytes: {
      "^": "Closure:50;$this,codeUnits,startIndex,endIndex",
    ...
    }, "call$1", "core_Uri_decodeComponent$closure", 2, 0, 60, 60],
    ...
    Iterable: {
      ...
      any$1: function(_, test) {
        ...
        for (t2 = this.get$iterator(this); t2.moveNext$0();)
          if (H.boolConversionCheck(test.call$1(H.assertSubtypeOfRuntimeType(t2.get$current(), t1))))
            return true;
        return false;
      },
      get$length: function(_) {
    ...
    }, "call$0", "modules__createEventPlugins$closure", 0, 0, 61],
    createNgZone: [function() {
      H.assertHelper(true);
      return Y.NgZone$(true);
    }, "call$0", "modules__createNgZone$closure", 0, 0, 62],
        ...
        if (C.JSString_methods.indexOf$1(className, " ") > -1) {
          ...
          for (len = classes.length, i = 0; i < len; ++i) {
            ...
            if (enabled) {
              ...
              t1 = H.stringTypeCheck(classes[i]);
              el.classList.add(t1);
            } else {
              if (i >= t1)
                return H.ioore(classes, i);
    ...
    DefaultKeyValueDiffer: {
      "^": "Object;_records,_mapHead,_appendAfter,_previousMapHead,_changesHead,_changesTail,_default_keyvalue_differ$_additionsHead,_default_keyvalue_differ$_additionsTail,_default_keyvalue_differ$_removalsHead",
      get$isDirty: function() {
      ...
      forEachChangedItem$1: function(fn) {
        var record;
        H.functionTypeCheck(fn, {func: 1, v: true, args: [N.KeyValueChangeRecord]});
      ...
      check$1: function(_, map) {
        ...
        if (record != null) {
          ...
          t1 = this._default_keyvalue_differ$_removalsHead;
          t2 = this._mapHead;
          if (t1 == null ? t2 == null : t1 === t2)
            this._mapHead = null;
          else
      ...
      _getOrCreateRecord$2: function(key, value) {
        ...
        if (t1.containsKey$1(0, key)) {
          ...
          t1 = record.get$_prev();
          if (!(t1 == null))
            t1._default_keyvalue_differ$_next = record.get$_default_keyvalue_differ$_next();
          t1 = record.get$_default_keyvalue_differ$_next();
          if (!(t1 == null))
            t1._prev = record.get$_prev();
          record.set$_prev(null);
          record.set$_default_keyvalue_differ$_next(null);
          return H.interceptedTypeCheck(record, "$isKeyValueChangeRecord");
        }
      ...
      _maybeAddToChanges$2: function(record, value) {
        var t1;
        H.interceptedTypeCheck(record, "$isKeyValueChangeRecord");
      ...
      _addToAdditions$1: function(record) {
        if (this._default_keyvalue_differ$_additionsHead == null) {
          this._default_keyvalue_differ$_additionsTail = record;
          this._default_keyvalue_differ$_additionsHead = record;
        } else {
          this._default_keyvalue_differ$_additionsTail._default_keyvalue_differ$_nextAdded = record;
          this._default_keyvalue_differ$_additionsTail = record;
        }
      },
      toString$0: function(_) {
        ...
        for (record = this._previousMapHead; record != null; record = record._default_keyvalue_differ$_nextPrevious)
          C.JSArray_methods.add$1(previous, record);
        for (record = this._changesHead; record != null; record = record._nextChanged)
    ...
    KeyValueChangeRecord: {
      ...
      set$_default_keyvalue_differ$_next: function(_next) {
        this._default_keyvalue_differ$_next = H.interceptedTypeCheck(_next, "$isKeyValueChangeRecord");
      },
      set$_prev: function(_prev) {
        this._prev = H.interceptedTypeCheck(_prev, "$isKeyValueChangeRecord");
      },
      toString$0: function(_) {
        var t1, t2, t3;
        ...
        t3 = this.key;
        return H.stringTypeCheck((t1 == null ? t2 == null : t1 === t2) ? t3 : H.S(t3) + "[" + H.S(this.previousValue) + "->" + H.S(this.currentValue) + "]");
      }
    }
    ...
    NgZone: {
      ...
      _onErrorWithLongStackTrace$2: [function(error, chain) {
        ...
        t4._sendData$1(t3);
      }, "call$2", "get$_onErrorWithLongStackTrace", 4, 0, 34, 2, 41],
      ...
      }, "call$5", "get$_createTimer", 10, 0, 35],
    ...
    _RuntimeInjector: {
      ...
      }, "useClass$1", "call$2$deps", "call$1", "get$useClass", 2, 3, 36, 0, 43, 27],
      useExisting$1: [function(to) {
        return this.inject$1(to);
      }, "call$1", "get$useExisting", 2, 0, 37],
      ...
      }, "useFactory$1", "call$2$deps", "call$1", "get$useFactory", 2, 3, 38, 0, 45, 27],
    ...
    BrowserExceptionHandler: {
      ...
      }, "call$2", "call$3", "call$1", "call$2", "get$$call", 2, 4, 18, 0, 0, 2, 53, 47],
      $isFunction: 1,
    ...
    PublicTestability: {
      ...
      whenStable$1: [function(callback) {
        ...
        t1._runCallbacksIfReady$0();
      }, "call$1", "get$whenStable", 2, 0, 41, 19],
      ...
      }, "findBindings$2", "call$3", "call$1", "call$2", "get$findBindings", 2, 4, 42, 0, 0, 20, 50, 51],
    ...
    BrowserGetTestability_addToWindow_closure: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 52, 20, 24, "call"]
    },
    ...
    DomEventsPlugin: {
      ...
      addEventListener$3: function(_, element, eventName, callback) {
        (element && C.FormElement_methods)._addEventListener$3(element, eventName, H.functionTypeCheck(callback, {func: 1, args: [W.Event]}), null);
        return;
      },
      ...
      static: {
        ...
        KeyEventsPlugin_getEventFullKey: function($event) {
          ...
          for (t1 = $.$get$modifierKeys(), fullKey = "", _i = 0; _i < 4; ++_i) {
            modifierName = t1[_i];
            if (modifierName !== key)
              if (J.$eq$($.$get$modifierKeyGetters().$index(0, modifierName).call$1($event), true))
                fullKey = C.JSString_methods.$add(fullKey, modifierName + ".");
          }
          return fullKey + key;
        },
    ...
    AbstractControlDirective: {
      ...
      get$value: function(_) {
        ...
        return t1 == null ? t1 : H.assertSubtypeOfRuntimeType(t1._model$_value, H.getRuntimeTypeArgument(t1, "AbstractControl", 0));
      }
    }
    ...
    ControlContainer: {
      ...
      get$control: function(_) {
        return H.assertSubtypeOfRuntimeType(null, H.getRuntimeTypeArgument(this, "ControlContainer", 0));
      }
    }
    ...
    DefaultValueAccessor: {
      ...
      registerOnTouched$1: function(fn) {
        this.set$onTouched(H.functionTypeCheck(fn, {func: 1, v: true}));
      },
    ...
    NgControlName: {
      ...
      get$control: function(_) {
        ...
        t1.toString;
        t1 = [P.String];
        t4 = H.assertSubtype([], "$isList", t1, "$asList");
        t5 = H.getTypeArgumentByIndex(t4, 0);
        t6 = [t5];
        t5 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(H.assertSubtype(t4.slice(0), "$isJSArray", t6, "$asJSArray"), t6), "$isJSArray", t6, "$asJSArray"), "$isList", [t5], "$asList");
        C.JSArray_methods.add$1(t5, t3);
        return H.interceptedTypeCast(Z._find(t2, H.assertSubtype(t5, "$isList", t1, "$asList")), "$isControl");
      }
    }
    ...
    NgForm: {
      ...
      addControl$1: function(dir) {
        var t1, t2, t3, t4, t5, t6, container, ctrl;
        t1 = dir.name;
        dir._ng_control_name$_parent.toString;
        t2 = P.String;
        t3 = [t2];
        t4 = H.assertSubtype([], "$isList", t3, "$asList");
        t5 = H.getTypeArgumentByIndex(t4, 0);
        t6 = [t5];
        t5 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(H.assertSubtype(t4.slice(0), "$isJSArray", t6, "$asJSArray"), t6), "$isJSArray", t6, "$asJSArray"), "$isList", [t5], "$asList");
        C.JSArray_methods.add$1(t5, t1);
        container = this.findContainer$1(H.assertSubtype(t5, "$isList", t3, "$asList"));
        ctrl = new Z.Control(null, null, null, null, new P._AsyncBroadcastStreamController(null, null, 0, null, null, null, null, [null]), H.assertSubtype(new P._AsyncBroadcastStreamController(null, null, 0, null, null, null, null, [t2]), "$isStreamController", [t2], "$asStreamController"), null, null, true, false, null, [null]);
        ctrl.updateValueAndValidity$2$emitEvent$onlySelf(false, true);
        t1 = dir.name;
      ...
      }, "call$1", "get$onSubmit", 2, 0, 47],
      findContainer$1: function(path) {
        var t1, t2;
        H.assertSubtype(path, "$isList", [P.String], "$asList");
    ...
    NgForm_removeControl_closure: {
      "^": "Closure:0;$this,dir",
      call$0: [function() {
        var t1, t2, t3, t4, t5, t6, container;
        t1 = this.dir;
        t2 = t1.name;
        ...
        t6 = [t5];
        t5 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(H.assertSubtype(t4.slice(0), "$isJSArray", t6, "$asJSArray"), t6), "$isJSArray", t6, "$asJSArray"), "$isList", [t5], "$asList");
        C.JSArray_methods.add$1(t5, t2);
        container = this.$this.findContainer$1(H.assertSubtype(t5, "$isList", t3, "$asList"));
        if (container != null) {
          t1 = t1.name;
    ...
    NgForm_updateModel_closure: {
      ...
      call$0: [function() {
        var t1, t2, t3, t4, t5, t6, ctrl;
        t1 = this.$this.form;
        t2 = this.dir;
        t3 = t2.name;
        t2._ng_control_name$_parent.toString;
        t2 = [P.String];
        t4 = H.assertSubtype([], "$isList", t2, "$asList");
        t5 = H.getTypeArgumentByIndex(t4, 0);
        t6 = [t5];
        t5 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(H.assertSubtype(t4.slice(0), "$isJSArray", t6, "$asJSArray"), t6), "$isJSArray", t6, "$asJSArray"), "$isList", [t5], "$asList");
        C.JSArray_methods.add$1(t5, t3);
        ctrl = H.interceptedTypeCheck(Z._find(t1, H.assertSubtype(t5, "$isList", t2, "$asList")), "$isControl");
        if (!(ctrl == null))
    ...
    normalizeValidator: [function(validator) {
      ...
      if (!!J.getInterceptor(validator).$isFunction)
        return H.functionTypeCheck(H.functionTypeCast(validator, t1), t1);
      else
        return H.functionTypeCheck(H.functionTypeCast(validator.get$$call(), t1), t1);
    }, "call$1", "normalize_validator__normalizeValidator$closure", 2, 0, 44, 40]
    ...
    SelectControlValueAccessor: {
      ...
      set$onChange: function(_, onChange) {
        this.onChange = H.functionTypeCheck(onChange, {func: 1, v: true, args: [P.String]});
      },
      set$onTouched: function(onTouched) {
        this.onTouched = H.functionTypeCheck(onTouched, {func: 1, v: true});
      },
      ...
      writeValue$1: function(value) {
        ...
        H.interceptedTypeCheck(this._select_control_value_accessor$_elementRef.nativeElement, "$isSelectElement").value = valueString;
      },
      registerOnChange$1: function(fn) {
        this.set$onChange(0, new X.SelectControlValueAccessor_registerOnChange_closure(this, H.functionTypeCheck(fn, {func: 1, args: [,]})));
      },
      registerOnTouched$1: function(fn) {
    ...
    SelectControlValueAccessor_registerOnChange_closure: {
      ...
      call$1: function(valueString) {
        var t1, value;
        H.stringTypeCheck(valueString);
        t1 = H.setRuntimeTypeInfo(valueString.split(":"), [P.String]);
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        value = this.$this._optionMap.$index(0, H.stringTypeCheck(t1[0]));
    ...
    setUpControl: function(control, dir) {
      ...
      if (H.assertTest(dir.valueAccessor != null)) {
        ...
        dir._ng_control_name$_parent.toString;
        t2 = [P.String];
        t3 = H.assertSubtype([], "$isList", t2, "$asList");
        t4 = H.getTypeArgumentByIndex(t3, 0);
        t5 = [t4];
        t4 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(H.assertSubtype(t3.slice(0), "$isJSArray", t5, "$asJSArray"), t5), "$isJSArray", t5, "$asJSArray"), "$isList", [t4], "$asList");
        C.JSArray_methods.add$1(t4, t1);
        H.assertThrow("No value accessor for (" + C.JSArray_methods.join$1(H.assertSubtype(t4, "$isList", t2, "$asList"), " -> ") + ") or you may be missing formDirectives in your directives list.");
      }
      control.set$validator(B.Validators_compose([control.validator, H.functionTypeCheck(X.composeValidators(dir._validators), {func: 1, ret: [P.Map, P.String,,], args: [Z.AbstractControl]})]));
      dir.valueAccessor.writeValue$1(H.assertSubtypeOfRuntimeType(control._model$_value, H.getTypeArgumentByIndex(control, 0)));
    ...
    _throwError: function(dir, message) {
      ...
      t4 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(H.assertSubtype(t3.slice(0), "$isJSArray", t5, "$asJSArray"), t5), "$isJSArray", t5, "$asJSArray"), "$isList", [t4], "$asList");
      C.JSArray_methods.add$1(t4, t1);
      H.assertSubtype(t4, "$isList", t2, "$asList");
      t1 = message + " (";
      t3 = dir.name;
      t4 = H.assertSubtype([], "$isList", t2, "$asList");
      t5 = H.getTypeArgumentByIndex(t4, 0);
      ...
      t5 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(H.assertSubtype(t4.slice(0), "$isJSArray", t6, "$asJSArray"), t6), "$isJSArray", t6, "$asJSArray"), "$isList", [t5], "$asList");
      C.JSArray_methods.add$1(t5, t3);
      message = t1 + C.JSArray_methods.join$1(H.assertSubtype(t5, "$isList", t2, "$asList"), " -> ") + ")";
    ...
    composeValidators: function(validators) {
      ...
      if (validators != null) {
        ...
        H.functionTypeCheck(D.normalize_validator__normalizeValidator$closure(), {func: 1, args: [t1]});
        t1 = B.Validators_compose(new H.MappedListIterable(H.listSuperNativeTypeCheck(validators, "$isIterable"), H.functionTypeCheck(D.normalize_validator__normalizeValidator$closure(), {func: 1, ret: null, args: [t1]}), [t1, null]).toList$0(0));
      } else
        t1 = null;
      return H.functionTypeCheck(t1, {func: 1, ret: [P.Map, P.String,,], args: [Z.AbstractControl]});
    },
    ...
    _find: function(control, path) {
      ...
      if (t1 === 0)
        return;
      return H.interceptedTypeCheck(C.JSArray_methods.fold$2(path, control, new Z._find_closure()), "$isAbstractControl");
    },
    _setParentForControls: function($parent, children) {
      var t1;
      H.listSuperNativeTypeCheck(children, "$isIterable");
      for (t1 = children.get$iterator(children); t1.moveNext$0();)
        t1.get$current().setParent$1($parent);
    },
    _find_closure: {
      "^": "Closure:3;",
    ...
    AbstractControl: {
      ...
      get$value: function(_) {
        return H.assertSubtypeOfRuntimeType(this._model$_value, H.getRuntimeTypeArgument(this, "AbstractControl", 0));
      },
    ...
    ControlGroup: {
      ...
      _reduceValue$0: function() {
        var t1, res;
        t1 = P.String;
        res = P.LinkedHashMap_LinkedHashMap$_empty(t1, null);
        this.controls.forEach$1(0, new Z.ControlGroup__reduceValue_closure(this, res));
        return H.assertSubtype(res, "$isMap", [t1, null], "$asMap");
      },
    ...
    ControlGroup__reduceValue_closure: {
      ...
      call$2: function($name, control) {
        ...
        this.res.$indexSet(0, $name, J.get$value$x(control));
      }
    }
    ...
    Validators_required: [function(control) {
      ...
      t1 = H.assertSubtypeOfRuntimeType(control._model$_value, H.getRuntimeTypeArgument(control, "AbstractControl", 0));
      t1 = t1 == null || J.$eq$(t1, "") ? P.LinkedHashMap__makeLiteral(["required", true]) : null;
      return H.assertSubtype(t1, "$isMap", [P.String, P.bool], "$asMap");
    }, "call$1", "validators0_Validators_required$closure", 2, 0, 63, 55],
    ...
    _executeValidators: function(control, validators) {
      ...
      for (len = validators.length, i = 0; i < len; ++i) {
        if (i >= validators.length)
          return H.ioore(validators, i);
        validator = validators[i];
        if (H.assertTest(validator != null))
    ...
    viewFactory_AppComponentHost0: [function(parentView, parentIndex) {
      ...
      return t1;
    }, "call$2", "app_component_template__viewFactory_AppComponentHost0$closure", 4, 0, 17],
    ...
    ViewAppComponent0: {
      "^": "AppView;_app_component_template$_el_0,_compView_0,_app_component_template$_HeroFormComponent_0_5,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        ...
        this._app_component_template$_HeroFormComponent_0_5 = t1;
        t2 = this._compView_0;
        t2.toString;
    ...
    HeroFormComponent: {
      ...
      set$submitted: function(submitted) {
        this.submitted = H.boolTypeCheck(submitted);
      },
      onSubmit$0: [function(_) {
        this.submitted = true;
        return true;
      }, "call$0", "get$onSubmit", 0, 0, 2],
      clear$0: [function(_) {
        var t1 = this.model;
        t1.name = "";
    ...
    viewFactory_HeroFormComponent1: [function(parentView, parentIndex) {
      var t1 = new T._ViewHeroFormComponent1(null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeLiteral(["$implicit", null]), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
      ...
      return H.assertSubtype(t1, "$isAppView", [X.HeroFormComponent], "$asAppView");
    }, "call$2", "hero_form_component_template__viewFactory_HeroFormComponent1$closure", 4, 0, 65],
    viewFactory_HeroFormComponentHost0: [function(parentView, parentIndex) {
      var t1 = new T._ViewHeroFormComponentHost0(null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
      t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex, null));
      return t1;
    }, "call$2", "hero_form_component_template__viewFactory_HeroFormComponentHost0$closure", 4, 0, 17],
    ...
    ViewHeroFormComponent0: {
      "^": "AppView;_el_0,_el_1,_el_2,_el_4,_NgForm_4_5,_ControlContainer_4_6,_el_5,_el_6,_el_8,_NgValidators_8_5,_DefaultValueAccessor_8_6,_NgValueAccessor_8_7,_NgControlName_8_8,_RequiredValidator_8_9,_el_9,_el_11,_el_12,_el_14,_DefaultValueAccessor_14_5,_NgValueAccessor_14_6,_NgControlName_14_7,_el_15,_el_16,_el_18,_NgClass_18_5,_NgValidators_18_6,_SelectControlValueAccessor_18_7,_NgValueAccessor_18_8,_NgControlName_18_9,_RequiredValidator_18_10,_appEl_19,_NgFor_19_9,_el_20,_el_21,_el_22,_el_24,_el_26,_el_28,_el_29,_el_31,_el_32,_el_33,_el_35,_text_36,_el_37,_el_38,_el_40,_text_41,_el_42,_el_43,_el_45,_text_46,_el_47,_expr_0,_expr_1,_expr_2,_expr_3,_expr_5,_expr_6,_expr_9,_expr_10,_expr_12,_expr_13,_expr_14,_expr_15,_expr_16,_expr_17,viewData,locals,parentView,componentType,rootEl,ctx",
      set$_NgValueAccessor_8_7: function(_NgValueAccessor_8_7) {
        this._NgValueAccessor_8_7 = H.assertSubtype(_NgValueAccessor_8_7, "$isList", [L.ControlValueAccessor], "$asList");
      },
      set$_NgValueAccessor_14_6: function(_NgValueAccessor_14_6) {
        this._NgValueAccessor_14_6 = H.assertSubtype(_NgValueAccessor_14_6, "$isList", [L.ControlValueAccessor], "$asList");
      },
      set$_NgValueAccessor_18_8: function(_NgValueAccessor_18_8) {
        this._NgValueAccessor_18_8 = H.assertSubtype(_NgValueAccessor_18_8, "$isList", [L.ControlValueAccessor], "$asList");
      },
      ...
      build$0: function() {
        var parentRenderNode, doc, t1, t2, t3, t4, t5, t6, t7, _text_7, t8, t9, _text_13, _text_17, _anchor_19, _text_23, _text_25, subscription_0, subscription_1, subscription_2, subscription_3;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._el_0 = t1;
        t1.className = "container";
        t1 = S.createDivAndAppend(doc, t1);
        this._el_1 = t1;
        t1 = S.createAndAppend(doc, "h1", t1);
        this._el_2 = t1;
        J.append$1$x(t1, doc.createTextNode("Hero Form"));
        this._el_4 = H.interceptedTypeCheck(S.createAndAppend(doc, "form", this._el_1), "$isFormElement");
        t1 = Z.ControlGroup;
        t2 = [t1];
        t3 = [t1];
        t4 = H.assertSubtype(new P._SyncBroadcastStreamController(null, null, 0, null, null, null, null, t2), "$isStreamController", t3, "$asStreamController");
        t2 = new L.NgForm(null, t4, H.assertSubtype(new P._SyncBroadcastStreamController(null, null, 0, null, null, null, null, t2), "$isStreamController", t3, "$asStreamController"), null);
        t3 = X.composeValidators(null);
        t4 = P.String;
        t5 = H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [t4, Z.AbstractControl], "$asMap");
        H.functionTypeCheck(t3, {func: 1, ret: [P.Map, P.String,,], args: [Z.AbstractControl]});
        t6 = [P.Map, P.String,,];
        t6 = H.assertSubtype(new P._AsyncBroadcastStreamController(null, null, 0, null, null, null, null, [t6]), "$isStreamController", [t6], "$asStreamController");
        t7 = H.assertSubtype(new P._AsyncBroadcastStreamController(null, null, 0, null, null, null, null, [t4]), "$isStreamController", [t4], "$asStreamController");
        t7 = new Z.ControlGroup(t5, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [t4, P.bool], "$asMap"), t3, null, t6, t7, null, null, true, false, null);
        t7.updateValueAndValidity$2$emitEvent$onlySelf(false, true);
        Z._setParentForControls(t7, t5.get$values(t5));
        t2.form = t7;
        this._NgForm_4_5 = t2;
        this._ControlContainer_4_6 = t2;
        t2 = S.createDivAndAppend(doc, this._el_4);
        this._el_5 = t2;
        t2.className = "form-group";
        t2 = S.createAndAppend(doc, "label", t2);
        this._el_6 = t2;
        J.setAttribute$2$x(t2, "for", "name");
        _text_7 = doc.createTextNode("Name\xa0*");
        J.append$1$x(this._el_6, _text_7);
        t2 = H.interceptedTypeCheck(S.createAndAppend(doc, "input", this._el_5), "$isInputElement");
        this._el_8 = t2;
        t2.className = "form-control";
        (t2 && C.InputElement_methods).setAttribute$2(t2, "id", "name");
        t2 = this._el_8;
        (t2 && C.InputElement_methods).setAttribute$2(t2, "ngControl", "name");
        t2 = this._el_8;
        (t2 && C.InputElement_methods).setAttribute$2(t2, "required", "");
        t2 = this._el_8;
        (t2 && C.InputElement_methods).setAttribute$2(t2, "type", "text");
        this._NgValidators_8_5 = [B.validators0_Validators_required$closure()];
        t2 = {func: 1, v: true, args: [,]};
        t7 = {func: 1, v: true};
        t5 = new O.DefaultValueAccessor(this._el_8, H.functionTypeCheck(new O.closure8(), t2), H.functionTypeCheck(new O.closure9(), t7));
        this._DefaultValueAccessor_8_6 = t5;
        this.set$_NgValueAccessor_8_7([t5]);
        t5 = this._ControlContainer_4_6;
        t6 = this._NgValidators_8_5;
        t3 = this._NgValueAccessor_8_7;
        t8 = [L.ControlValueAccessor];
        H.assertSubtype(t3, "$isList", t8, "$asList");
        t9 = [null];
        t5 = new N.NgControlName(t5, t6, new P._AsyncBroadcastStreamController(null, null, 0, null, null, null, null, t9), false, null, null, false, null, null);
        t5.valueAccessor = X.selectValueAccessor(t5, t3);
        this._NgControlName_8_8 = t5;
        this._RequiredValidator_8_9 = new B.RequiredValidator();
        t5 = S.createDivAndAppend(doc, this._el_5);
        this._el_9 = t5;
        t5.className = "invalid-feedback";
        (t5 && C.DivElement_methods).append$1(t5, doc.createTextNode("Name is required"));
        t5 = S.createDivAndAppend(doc, this._el_4);
        this._el_11 = t5;
        t5.className = "form-group";
        t5 = S.createAndAppend(doc, "label", t5);
        this._el_12 = t5;
        J.setAttribute$2$x(t5, "for", "alterEgo");
        _text_13 = doc.createTextNode("Alter Ego");
        J.append$1$x(this._el_12, _text_13);
        t5 = H.interceptedTypeCheck(S.createAndAppend(doc, "input", this._el_11), "$isInputElement");
        this._el_14 = t5;
        t5.className = "form-control";
        (t5 && C.InputElement_methods).setAttribute$2(t5, "id", "alterEgo");
        t5 = this._el_14;
        (t5 && C.InputElement_methods).setAttribute$2(t5, "ngControl", "alterEgo");
        t5 = this._el_14;
        (t5 && C.InputElement_methods).setAttribute$2(t5, "type", "text");
        t5 = new O.DefaultValueAccessor(this._el_14, H.functionTypeCheck(new O.closure8(), t2), H.functionTypeCheck(new O.closure9(), t7));
        this._DefaultValueAccessor_14_5 = t5;
        this.set$_NgValueAccessor_14_6([t5]);
        t5 = this._ControlContainer_4_6;
        t3 = this._NgValueAccessor_14_6;
        H.assertSubtype(t3, "$isList", t8, "$asList");
        t5 = new N.NgControlName(t5, null, new P._AsyncBroadcastStreamController(null, null, 0, null, null, null, null, t9), false, null, null, false, null, null);
        t5.valueAccessor = X.selectValueAccessor(t5, t3);
        this._NgControlName_14_7 = t5;
        t5 = S.createDivAndAppend(doc, this._el_4);
        this._el_15 = t5;
        t5.className = "form-group";
        t5 = S.createAndAppend(doc, "label", t5);
        this._el_16 = t5;
        J.setAttribute$2$x(t5, "for", "power");
        _text_17 = doc.createTextNode("Hero Power\xa0*");
        J.append$1$x(this._el_16, _text_17);
        t5 = H.interceptedTypeCheck(S.createAndAppend(doc, "select", this._el_15), "$isSelectElement");
        this._el_18 = t5;
        t5.className = "form-control";
        (t5 && C.SelectElement_methods).setAttribute$2(t5, "id", "power");
        t5 = this._el_18;
        (t5 && C.SelectElement_methods).setAttribute$2(t5, "ngControl", "power");
        t5 = this._el_18;
        (t5 && C.SelectElement_methods).setAttribute$2(t5, "required", "");
        t5 = this._el_18;
        this._NgClass_18_5 = new Y.NgClass(t5, null, null, H.assertSubtype([], "$isList", [t4], "$asList"), null);
        this._NgValidators_18_6 = [B.validators0_Validators_required$closure()];
        t3 = new X.SelectControlValueAccessor(new Z.ElementRef(t5), null, H.assertSubtype(H.assertSubtype(new H.JsLinkedHashMap(0, null, null, null, null, null, 0, [t4, null]), "$isJsLinkedHashMap", [t4, null], "$asJsLinkedHashMap"), "$isMap", [t4, null], "$asMap"), 0, H.functionTypeCheck(new X.closure10(), {func: 1, v: true, args: [P.String]}), H.functionTypeCheck(new X.closure11(), t7));
        this._SelectControlValueAccessor_18_7 = t3;
        this.set$_NgValueAccessor_18_8([t3]);
        t3 = this._ControlContainer_4_6;
        t4 = this._NgValidators_18_6;
        t5 = this._NgValueAccessor_18_8;
        H.assertSubtype(t5, "$isList", t8, "$asList");
        t3 = new N.NgControlName(t3, t4, new P._AsyncBroadcastStreamController(null, null, 0, null, null, null, null, t9), false, null, null, false, null, null);
        t3.valueAccessor = X.selectValueAccessor(t3, t5);
        this._NgControlName_18_9 = t3;
        this._RequiredValidator_18_10 = new B.RequiredValidator();
        t3 = $.$get$ngAnchor();
        _anchor_19 = (t3 && C.Comment_methods).clone$1(t3, false);
        t3 = this._el_18;
        (t3 && C.SelectElement_methods).append$1(t3, _anchor_19);
        t3 = new V.ViewContainer(19, 18, this, _anchor_19, null, null, null);
        this._appEl_19 = t3;
        this._NgFor_19_9 = new R.NgFor(t3, null, null, null, new D.TemplateRef(t3, H.interceptedTypeCheck(T.hero_form_component_template__viewFactory_HeroFormComponent1$closure(), "$isFunction")));
        t3 = S.createDivAndAppend(doc, this._el_4);
        this._el_20 = t3;
        t3.className = "row";
        t3 = S.createDivAndAppend(doc, t3);
        this._el_21 = t3;
        t3.className = "col-auto";
        t3 = H.interceptedTypeCheck(S.createAndAppend(doc, "button", t3), "$isButtonElement");
        this._el_22 = t3;
        t3.className = "btn btn-primary";
        (t3 && C.ButtonElement_methods).setAttribute$2(t3, "type", "submit");
        _text_23 = doc.createTextNode("Submit");
        t3 = this._el_22;
        (t3 && C.ButtonElement_methods).append$1(t3, _text_23);
        t3 = H.interceptedTypeCheck(S.createAndAppend(doc, "button", this._el_21), "$isButtonElement");
        this._el_24 = t3;
        t3.className = "btn";
        (t3 && C.ButtonElement_methods).setAttribute$2(t3, "type", "button");
        _text_25 = doc.createTextNode("Clear");
        t3 = this._el_24;
        (t3 && C.ButtonElement_methods).append$1(t3, _text_25);
        t3 = S.createAndAppend(doc, "small", this._el_20);
        this._el_26 = t3;
        t3.className = "col text-right";
        J.append$1$x(t3, doc.createTextNode("*\xa0Required"));
        t3 = S.createDivAndAppend(doc, this._el_0);
        this._el_28 = t3;
        t3 = S.createAndAppend(doc, "h1", t3);
        this._el_29 = t3;
        J.append$1$x(t3, doc.createTextNode("Hero data"));
        t3 = H.interceptedTypeCheck(S.createAndAppend(doc, "table", this._el_28), "$isTableElement");
        this._el_31 = t3;
        t3.className = "table";
        t3 = S.createAndAppend(doc, "tr", t3);
        this._el_32 = t3;
        t3 = S.createAndAppend(doc, "th", t3);
        this._el_33 = t3;
        J.append$1$x(t3, doc.createTextNode("Name"));
        t3 = S.createAndAppend(doc, "td", this._el_32);
        this._el_35 = t3;
        t5 = doc.createTextNode("");
        this._text_36 = t5;
        J.append$1$x(t3, t5);
        t5 = S.createAndAppend(doc, "tr", this._el_31);
        this._el_37 = t5;
        t5 = S.createAndAppend(doc, "th", t5);
        this._el_38 = t5;
        J.append$1$x(t5, doc.createTextNode("Alter Ego"));
        t5 = S.createAndAppend(doc, "td", this._el_37);
        this._el_40 = t5;
        t3 = doc.createTextNode("");
        this._text_41 = t3;
        J.append$1$x(t5, t3);
        t3 = S.createAndAppend(doc, "tr", this._el_31);
        this._el_42 = t3;
        t3 = S.createAndAppend(doc, "th", t3);
        this._el_43 = t3;
        J.append$1$x(t3, doc.createTextNode("Power"));
        t3 = S.createAndAppend(doc, "td", this._el_42);
        this._el_45 = t3;
        t5 = doc.createTextNode("");
        this._text_46 = t5;
        J.append$1$x(t3, t5);
        t5 = H.interceptedTypeCheck(S.createAndAppend(doc, "button", this._el_28), "$isButtonElement");
        this._el_47 = t5;
        t5.className = "btn btn-primary";
        (t5 && C.ButtonElement_methods).append$1(t5, doc.createTextNode("Edit"));
        t5 = $.appViewUtils.eventManager;
        t3 = this._el_4;
        t4 = this._NgForm_4_5;
        t4 = this.eventHandler1$1(t4.get$onSubmit(t4));
        t5.toString;
        H.functionTypeCheck(t4, t2);
        t5._findPluginFor$1("submit").addEventListener$3(0, t3, "submit", t4);
        t4 = this._NgForm_4_5._ngSubmit;
        t3 = H.getTypeArgumentByIndex(t4, 0);
        t1 = H.assertSubtype(H.assertSubtype(new P._BroadcastStream(H.assertSubtype(t4, "$is_StreamControllerLifecycle", [t3], "$as_StreamControllerLifecycle"), [t3]), "$isStream", [t3], "$asStream"), "$isStream", [t1], "$asStream");
        t3 = this.ctx;
        subscription_0 = t1.listen$1(this.eventHandler0$1(t3.get$onSubmit(t3)));
        t3 = this._el_8;
        t1 = this.eventHandler1$1(this.get$_handle_input_8_1());
        t3.toString;
        t4 = {func: 1, args: [W.Event]};
        H.functionTypeCheck(t1, t4);
        (t3 && C.InputElement_methods)._addEventListener$3(t3, "input", t1, null);
        t1 = this._el_8;
        t2 = this.eventHandler0$1(this._DefaultValueAccessor_8_6.get$touchHandler());
        t1.toString;
        H.functionTypeCheck(t2, t4);
        (t1 && C.InputElement_methods)._addEventListener$3(t1, "blur", t2, null);
        t1 = this._NgControlName_8_8._update;
        t2 = H.getTypeArgumentByIndex(t1, 0);
        subscription_1 = H.assertSubtype(new P._BroadcastStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [t2], "$as_StreamControllerLifecycle"), [t2]), "$isStream", [t2], "$asStream").listen$1(this.eventHandler1$1(this.get$_handle_ngModelChange_8_0()));
        t2 = this._el_14;
        t1 = this.eventHandler1$1(this.get$_handle_input_14_1());
        t2.toString;
        H.functionTypeCheck(t1, t4);
        (t2 && C.InputElement_methods)._addEventListener$3(t2, "input", t1, null);
        t1 = this._el_14;
        t2 = this.eventHandler0$1(this._DefaultValueAccessor_14_5.get$touchHandler());
        t1.toString;
        H.functionTypeCheck(t2, t4);
        (t1 && C.InputElement_methods)._addEventListener$3(t1, "blur", t2, null);
        t1 = this._NgControlName_14_7._update;
        t2 = H.getTypeArgumentByIndex(t1, 0);
        subscription_2 = H.assertSubtype(new P._BroadcastStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [t2], "$as_StreamControllerLifecycle"), [t2]), "$isStream", [t2], "$asStream").listen$1(this.eventHandler1$1(this.get$_handle_ngModelChange_14_0()));
        t2 = this._el_18;
        t1 = this.eventHandler1$1(this.get$_handle_change_18_1());
        t2.toString;
        H.functionTypeCheck(t1, t4);
        (t2 && C.SelectElement_methods)._addEventListener$3(t2, "change", t1, null);
        t1 = this._el_18;
        t2 = this.eventHandler0$1(this._SelectControlValueAccessor_18_7.get$touchHandler());
        t1.toString;
        H.functionTypeCheck(t2, t4);
        (t1 && C.SelectElement_methods)._addEventListener$3(t1, "blur", t2, null);
        t1 = this._NgControlName_18_9._update;
        t2 = H.getTypeArgumentByIndex(t1, 0);
        subscription_3 = H.assertSubtype(new P._BroadcastStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [t2], "$as_StreamControllerLifecycle"), [t2]), "$isStream", [t2], "$asStream").listen$1(this.eventHandler1$1(this.get$_handle_ngModelChange_18_0()));
        t2 = this._el_24;
        t1 = this.ctx;
        t1 = this.eventHandler0$1(t1.get$clear(t1));
        t2.toString;
        H.functionTypeCheck(t1, t4);
        (t2 && C.ButtonElement_methods)._addEventListener$3(t2, "click", t1, null);
        t1 = this._el_47;
        t2 = this.eventHandler1$1(this.get$_handle_click_47_0());
        t1.toString;
        H.functionTypeCheck(t2, t4);
        (t1 && C.ButtonElement_methods)._addEventListener$3(t1, "click", t2, null);
        this.init$2(C.List_empty0, [subscription_0, subscription_1, subscription_2, subscription_3]);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        var t1, t2, t3, t4, t5;
        t1 = token === C.MultiToken_NgValidators;
        if (t1 && 8 === nodeIndex)
          return this._NgValidators_8_5;
        t2 = token === C.Type_DefaultValueAccessor_EOZ;
        if (t2 && 8 === nodeIndex)
          return this._DefaultValueAccessor_8_6;
        t3 = token === C.MultiToken_NgValueAccessor;
        if (t3 && 8 === nodeIndex)
        ...
        if (t5 && 8 === nodeIndex)
          return this._RequiredValidator_8_9;
        if (t2 && 14 === nodeIndex)
        ...
        if (t5 && 18 <= nodeIndex && nodeIndex <= 19)
          return this._RequiredValidator_18_10;
      ...
      detectChangesInternal$0: function() {
        var _ctx, firstCheck, local_name, local_power, local_heroForm, changed, currVal_3, t1, currVal_6, t2, currVal_9, t3, t4, changes, currVal_10, currVal_0, currVal_1, currVal_2, currVal_5, currVal_13, currVal_14, currVal_15, currVal_16, currVal_17;
        _ctx = H.interceptedTypeCheck(this.ctx, "$isHeroFormComponent");
        firstCheck = this.viewData._cdState === 0;
        local_name = this._NgControlName_8_8;
        local_power = this._NgControlName_18_9;
        local_heroForm = this._NgForm_4_5;
        if (firstCheck) {
          local_name.name = "name";
          changed = true;
        } else
          changed = false;
        currVal_3 = _ctx.model.name;
        t1 = this._expr_3;
        if (t1 == null ? currVal_3 != null : t1 !== currVal_3) {
          t1 = this._NgControlName_8_8;
        ...
        if (changed)
          this._NgControlName_8_8.ngAfterChanges$0();
        if (firstCheck) {
          this._NgControlName_14_7.name = "alterEgo";
          changed = true;
        } else
          changed = false;
        currVal_6 = _ctx.model.alterEgo;
        t1 = this._expr_6;
        if (t1 == null ? currVal_6 != null : t1 !== currVal_6) {
          t1 = this._NgControlName_14_7;
          t1._modelChanged = true;
          t1._model = currVal_6;
        ...
        if (changed)
          this._NgControlName_14_7.ngAfterChanges$0();
        if (firstCheck) {
          t1 = this._NgClass_18_5;
          t1._applyInitialClasses$1(true);
          t2 = H.setRuntimeTypeInfo("form-control".split(" "), [P.String]);
          t1.set$_initialClasses(t2);
          t1._applyInitialClasses$1(false);
          t1._applyClasses$2(t1._rawClass, false);
        }
        _ctx.toString;
        t1 = local_power.get$control(local_power);
        t2 = P.String;
        currVal_9 = H.assertSubtype(P.LinkedHashMap__makeLiteral([H.boolTypeCheck(t1 == null ? t1 : t1._status === "VALID") === true ? "is-valid" : "is-invalid", true]), "$isMap", [t2, P.bool], "$asMap");
        if (this._expr_9 !== currVal_9) {
          ...
          t3 = N.KeyValueChangeRecord;
          t4 = [null, t3];
          t1._keyValueDiffer = new N.DefaultKeyValueDiffer(H.assertSubtype(H.assertSubtype(new H.JsLinkedHashMap(0, null, null, null, null, null, 0, t4), "$isJsLinkedHashMap", t4, "$asJsLinkedHashMap"), "$isMap", [null, t3], "$asMap"), null, null, null, null, null, null, null, null);
          this._expr_9 = currVal_9;
        }
        t1 = this._NgClass_18_5;
        t3 = t1._iterableDiffer;
        if (t3 != null) {
          changes = t3.diff$1(t1._rawClass);
          if (changes != null)
            t1._applyIterableChanges$1(changes);
        }
        t3 = t1._keyValueDiffer;
        if (t3 != null) {
          changes = t3.diff$1(t1._rawClass);
          if (changes != null)
        ...
        if (firstCheck) {
          ...
          changed = false;
        currVal_10 = _ctx.model.power;
        t1 = this._expr_10;
        if (t1 == null ? currVal_10 != null : t1 !== currVal_10) {
          t1 = this._NgControlName_18_9;
          t1._modelChanged = true;
        ...
        if (changed)
          this._NgControlName_18_9.ngAfterChanges$0();
        H.assertSubtype(C.List_0M2, "$isList", [t2], "$asList");
        if (this._expr_12 !== C.List_0M2) {
          t1 = this._NgFor_19_9;
          t1.toString;
          if (H.assertTest(true))
            H.assertThrow("Cannot diff `" + H.S(C.List_0M2) + "`. " + C.Type_NgFor_FUV.toString$0(0) + " only supports binding to something that implements the `Iterable` interface, such as `List`.");
          t1._ngForOf = C.List_0M2;
        ...
        currVal_0 = _ctx.submitted;
        if (this._expr_0 !== currVal_0) {
          this._el_1.hidden = currVal_0;
          this._expr_0 = currVal_0;
        }
        t1 = local_name.get$control(local_name);
        currVal_1 = H.boolTypeCheck(t1 == null ? t1 : t1._status === "VALID");
        t1 = this._expr_1;
        ...
        t1 = local_name.get$control(local_name);
        currVal_2 = !H.boolConversionCheck(H.boolTypeCheck(t1 == null ? t1 : t1._status === "VALID"));
        if (this._expr_2 !== currVal_2) {
          this.updateClass$3(this._el_8, "is-invalid", currVal_2);
          this._expr_2 = currVal_2;
        }
        t1 = local_name.get$control(local_name);
        if (!H.boolConversionCheck(H.boolTypeCheck(t1 == null ? t1 : t1._status === "VALID"))) {
          t1 = local_name.get$control(local_name);
          currVal_5 = H.boolConversionCheck(H.boolTypeCheck(t1 == null ? t1 : t1._pristine));
        } else
          currVal_5 = true;
        ...
        currVal_14 = !_ctx.submitted;
        if (this._expr_14 !== currVal_14) {
          this._el_28.hidden = currVal_14;
          this._expr_14 = currVal_14;
        }
        currVal_15 = Q.interpolate0(_ctx.model.name);
        if (this._expr_15 !== currVal_15) {
          this._text_36.textContent = currVal_15;
          this._expr_15 = currVal_15;
        }
        currVal_16 = Q.interpolate0(_ctx.model.alterEgo);
        if (this._expr_16 !== currVal_16) {
          this._text_41.textContent = currVal_16;
          this._expr_16 = currVal_16;
        }
        currVal_17 = Q.interpolate0(_ctx.model.power);
        if (this._expr_17 !== currVal_17) {
          this._text_46.textContent = currVal_17;
      ...
      _handle_ngModelChange_8_0$1: [function($$event) {
        this.ctx.get$model().name = H.stringTypeCheck($$event);
      }, "call$1", "get$_handle_ngModelChange_8_0", 2, 0, 4],
      _handle_input_8_1$1: [function($$event) {
        var t1, t2;
        t1 = this._DefaultValueAccessor_8_6;
      ...
      _handle_ngModelChange_14_0$1: [function($$event) {
        this.ctx.get$model().alterEgo = H.stringTypeCheck($$event);
      }, "call$1", "get$_handle_ngModelChange_14_0", 2, 0, 4],
      _handle_input_14_1$1: [function($$event) {
        var t1, t2;
        t1 = this._DefaultValueAccessor_14_5;
        t2 = J.get$value$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_handle_input_14_1", 2, 0, 4],
      _handle_ngModelChange_18_0$1: [function($$event) {
        this.ctx.get$model().power = H.stringTypeCheck($$event);
      }, "call$1", "get$_handle_ngModelChange_18_0", 2, 0, 4],
      _handle_change_18_1$1: [function($$event) {
        var t1, t2;
        t1 = this._SelectControlValueAccessor_18_7;
        t2 = J.get$value$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_handle_change_18_1", 2, 0, 4],
      _handle_click_47_0$1: [function($$event) {
        this.ctx.set$submitted(false);
      }, "call$1", "get$_handle_click_47_0", 2, 0, 4],
      $asAppView: function() {
        return [X.HeroFormComponent];
      },
      static: {
        ViewHeroFormComponent0$: function(parentView, parentIndex) {
          var t1 = new T.ViewHeroFormComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
    ...
    _ViewHeroFormComponent1: {
      "^": "AppView;_el_0,_NgSelectOption_0_5,_text_1,_expr_0,_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1, t2;
        doc = document;
        t1 = doc.createElement("option");
        H.interceptedTypeCheck(t1, "$isOptionElement");
        this._el_0 = t1;
        t2 = H.interceptedTypeCast(this.parentView, "$isViewHeroFormComponent0")._SelectControlValueAccessor_18_7;
        t1 = new X.NgSelectOption(new Z.ElementRef(t1), t2, null);
        if (t2 != null)
          t1.id = C.JSInt_methods.toString$0(t2._idCounter++);
        this._NgSelectOption_0_5 = t1;
        t1 = doc.createTextNode("");
        this._text_1 = t1;
        t2 = this._el_0;
        (t2 && C.OptionElement_methods).append$1(t2, t1);
      ...
      detectChangesInternal$0: function() {
        ...
        local_p = H.stringTypeCheck(this.locals.$index(0, "$implicit"));
        t1 = this._expr_0;
        if (t1 == null ? local_p != null : t1 !== local_p) {
          t1 = this._NgSelectOption_0_5;
          H.interceptedTypeCheck(t1._select_control_value_accessor$_element.nativeElement, "$isOptionElement").value = local_p;
          t1 = t1._select;
          if (t1 != null)
    ...
    _ViewHeroFormComponentHost0: {
      "^": "AppView;_hero_form_component_template$_compView_0,_HeroFormComponent_0_5,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = T.ViewHeroFormComponent0$(this, 0);
        this._hero_form_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new X.HeroFormComponent(new G.Hero(18, "Dr IQ", "Really Smart", "Chuck Overstreet"), false);
        this._HeroFormComponent_0_5 = t2;
        t3 = this.viewData.projectableNodes;
        ...
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroFormComponent_0_5, [X.HeroFormComponent]);
      },
      detectChangesInternal$0: function() {
        this._hero_form_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._hero_form_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      },
      $asAppView: Isolate.functionThatReturnsNull
    ...
    StackZoneSpecification: {
      ...
      }, "call$5", "get$_stack_zone_specification$_errorCallback", 10, 0, 22],
  ...
  C.ComponentFactory_qBb = new D.ComponentFactory("hero-form", T.hero_form_component_template__viewFactory_HeroFormComponentHost0$closure(), C.List_empty0, [X.HeroFormComponent]);
...
;
  ...
  C.MultiToken_NgValidators = new S.MultiToken("NgValidators", [null]);
  ...
  }, "ElementEvents_webkitEvents", "trackByIdentity", "$get$trackByIdentity", function() {
    return new R.closure16();
  ...
  }, "_dependencies", "modifierKeys", "$get$modifierKeys", function() {
    return ["alt", "control", "meta", "shift"];
  }, "modifierKeys", "modifierKeyGetters", "$get$modifierKeyGetters", function() {
    return H.assertSubtype(P.LinkedHashMap__makeLiteral(["alt", new N.closure12(), "control", new N.closure13(), "meta", new N.closure14(), "shift", new N.closure15()]), "$isMap", [P.String, null], "$asMap");
  ...
  $ = new Isolate();
  init.metadata = [null, "_", "error", "line", "stackTrace", "arg", "p0", "trace", "frame", "self", "parent", "zone", "result", "p1", "arg1", "arg2", "f", "value", "invocation", "callback", "elem", "event", "e", "x", "findInAncestors", "p2", "t", "deps", "err", "element", "arg3", "s", "o", "ref", "specification", "isolate", "numberOfArguments", "closure", "index", "item", "validator", "chain", "errorCode", "clazz", "theError", "factory", "arguments", "reason", "object", "sender", "binding", "exactMatch", true, "stack", "didWork_", "control", "zoneValues", "arg4", "each", "theStackTrace", "encodedComponent"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [,]}, {func: 1, args: [W.KeyboardEvent]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [N.KeyValueChangeRecord]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, v: true}]}, {func: 1, v: true, args: [P.Uint8List, P.String, P.int]}, {func: 1, args: [P.bool]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, args: [P.String]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, args: [P.int,,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, ret: S.AppView, args: [S.AppView, P.num]}, {func: 1, v: true, args: [,], opt: [, P.String]}, {func: 1, args: [R.CollectionChangeRecord]}, {func: 1, ret: P.String}, {func: 1, ret: P.Future}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}, {func: 1, ret: P.Uint8List, args: [,,]}, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, args: [R.CollectionChangeRecord, P.int, P.int]}, {func: 1, args: [Y.NgZoneError]}, {func: 1, args: [Y.PlatformRefImpl, Y.NgZone, M.Injector]}, {func: 1, args: [P.String, E.SanitizationService, N.EventManager]}, {func: 1, args: [M.ComponentLoader, V.ComponentResolver]}, {func: 1, args: [Y.NgZone]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, U.Chain]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1}]}, {func: 1, ret: P.Object, args: [P.Type], named: {deps: [P.List, P.Object]}}, {func: 1, ret: P.Object, args: [P.Object]}, {func: 1, ret: P.Object, args: [P.Function], named: {deps: [P.List, P.Object]}}, {func: 1, v: true, args: [P.String, P.int]}, {func: 1, ret: P.bool}, {func: 1, v: true, args: [P.Function]}, {func: 1, ret: P.List, args: [W.Element], opt: [P.String, P.bool]}, {func: 1, args: [W.Element], opt: [P.bool]}, {func: 1, ret: {func: 1, ret: [P.Map, P.String,,], args: [Z.AbstractControl]}, args: [,]}, {func: 1, args: [[P.List, N.EventManagerPlugin], Y.NgZone]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, v: true, args: [W.Event]}, {func: 1, args: [,], named: {rawValue: P.String}}, {func: 1, args: [Z.AbstractControl]}, {func: 1, v: true, args: [P.int, P.int]}, {func: 1, ret: P.int, args: [[P.List, P.int], P.int]}, {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, args: [P.String,,]}, {func: 1, v: true, args: [P.Object]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.String]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneDelegate, P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: [P.List, N.EventManagerPlugin]}, {func: 1, ret: Y.NgZone}, {func: 1, ret: [P.Map, P.String, P.bool], args: [Z.AbstractControl]}, {func: 1, args: [, P.String]}, {func: 1, ret: [S.AppView, X.HeroFormComponent], args: [S.AppView, P.num]}, {func: 1, args: [W.Element, P.bool]}];
